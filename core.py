...
async def main():
	...
	output_file_mutans_selected = 'resources/shopizer_selected_mutations.json'
	selector_max_mutants_per_method(output_mut_infos_json_filename, output_file_mutans_selected, 2)
	mutations_info = read_mut_infos_from_file(output_file_mutans_selected)  # read the info about mutations
